...
import { AppWindow, Archive, Bank, Brain, Broadcast, Buildings, CalendarBlank, ChartLine, CloudSun, Code, CurrencyDollar, Envelope, FileText, Globe, GraduationCap, Graph, Heartbeat, MagnifyingGlass, MapTrifold, Microphone, Newspaper, Pulse, Scales, ShoppingCart, Users, } from '@phosphor-icons/react';
const RULES = [
...
export function AppIcon({ src, name, description, size = 16, className = '' }) {
    ...
    return (_jsx("span", { className: `${cls} appicon-glyph`, "aria-hidden": "true", children: _jsx(Glyph, { size: size, weight: "duotone" }) }));
}
