...
function QueryStudioBody({ handedOver, initialCypher, handoffRevision, onCypherChange }) {
    ...
    const paneNavRef = (0, react_2.useRef)(null);
    const sectionsRef = (0, react_2.useRef)(null);
    const sectionRefs = (0, react_2.useRef)({});
    const pendingPaneScroll = (0, react_2.useRef)(false);
    ...
    (0, react_2.useEffect)(() => { handle.editor?.refresh(); }, [editorExpanded, handle.editor]);
