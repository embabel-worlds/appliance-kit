...
exports.PEEK_LIMIT = void 0;
exports.planLine = planLine;
exports.completeQuery = completeQuery;
exports.pipelineText = pipelineText;
exports.PEEK_LIMIT = 25;
...
function planLine(raw, current, nextAutoName, findByName, findByVariable) {
    ...
    if (peek) {
        return {
            kind: 'run',
            cypher: `MATCH ${scopeRef('x', peek[1])} RETURN x LIMIT ${exports.PEEK_LIMIT}`,
            tabular: true,
            note: `peeking $${peek[1]} — first ${exports.PEEK_LIMIT}`,
        };
    }
