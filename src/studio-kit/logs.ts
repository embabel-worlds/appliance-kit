 ...
 */
export function severityOfLine(line: string): LogSeverity {
...
export function severityOfLevel(level: string | null | undefined): LogSeverity {
...
export function matchesFilter(line: string, needle: string): boolean {
 ...
 */
export function isAtBottom(view: { scrollHeight: number; scrollTop: number; clientHeight: number }): boolean {
 ...
 */
export function pendingBehind(total: number, shownUpTo: number): number {
